<template>
  <section class="space-y-6" v-if="result">
    ...
    >
      ...
      <span class="text-xs font-bold uppercase tracking-wider">Salin Teks Lengkap</span>
    </button>
...
const buildShareText = () => {
  ...
  return [
    ...
    "",
    props.result?.terjemahan || "-",
    "",
    "I'rab:",
    "",
    irabText || "-",
    "",
    "Generated by BacoKitab — https://bacokitab.vercel.app",
  ].join("\n");
};

const copyFullShareText = async () => {
  await copyToClipboard(buildShareText(), "Teks Lengkap");
};
